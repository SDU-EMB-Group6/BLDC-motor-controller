...
################################################################
# This is a generated script based on design: BLDC_design
#
...
# source BLDC_design_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# btn_counter, debounce, debounce
...
proc create_root_design { parentCell } {
  ...
  # Create instance: btn_counter_0, and set properties
  set block_name btn_counter
  set block_cell_name btn_counter_0
  if { [catch {set btn_counter_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $btn_counter_0 eq "" } {
...
CONFIG.PCW_WDT_PERIPHERAL_FREQMHZ {133.333333} \
  ...
  connect_bd_net -net btn_counter_0_counter_out [get_bd_ports counter_out] [get_bd_pins btn_counter_0/counter_out]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins btn_counter_0/clk_200M_in] [get_bd_pins debounce_0/clk_200M_in] [get_bd_pins debounce_1/clk_200M_in] [get_bd_pins processing_system7_0/FCLK_CLK1]
