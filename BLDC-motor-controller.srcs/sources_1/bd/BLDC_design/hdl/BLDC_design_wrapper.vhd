...
architecture STRUCTURE of BLDC_design_wrapper is
  component BLDC_design is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
begin
BLDC_design_i: component BLDC_design
     port map (
