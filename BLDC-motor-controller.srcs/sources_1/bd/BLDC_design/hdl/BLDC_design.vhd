...
entity BLDC_design is
  ...
  attribute CORE_GENERATION_INFO of BLDC_design : entity is "BLDC_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=BLDC_design,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of BLDC_design : entity is "BLDC_design.hwdef";
end BLDC_design;

architecture STRUCTURE of BLDC_design is
  component BLDC_design_processing_system7_0_0 is
  port (
